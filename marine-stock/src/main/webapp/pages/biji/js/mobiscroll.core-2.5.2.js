    ...
    function Scroller(elem, settings) {
        ...
        */
        that.show = function (prevAnim) {
            ...
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb">' + s.setText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n"><span class="dwb">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb">' + s.cancelText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '</div></div><div class="float_clear"></div></div>';
            dw = $(html);
            ...
            if (s.display != 'inline') {
                ...
                that.tap($('.float_clear'), function () {
                    that.cancel();
                });
				
                //function touchStart() {
	                 //$(".android-ics").attr("visible","false");
					 //that.cancel();
                //};
