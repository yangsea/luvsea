...
import com.luvsea.common.util.JaxbParser;
import com.luvsea.common.utils.StreamUtils;
import com.luvsea.wechat.common.encryption.ValidateSignature;
import com.luvsea.wechat.common.event.EventType;
import com.luvsea.wechat.common.event.MsgType;
import com.luvsea.wechat.common.param.SignatureParam;
import com.luvsea.wechat.request.WechatRequest;
import com.luvsea.wechat.response.ArticleResponse;
import com.luvsea.wechat.response.ImageResponse;
import com.luvsea.wechat.response.MusicResponse;
import com.luvsea.wechat.response.TransInfoResponse;
import com.luvsea.wechat.response.VideoResponse;
import com.luvsea.wechat.response.VoiceResponse;
import com.luvsea.wechat.response.WechatResponse;
...
public abstract class WechatSupport {
	...
	private String dispatch() {
		...
		try {
			 postDataStr = StreamUtils.InputStreamTOString(request.getInputStream());
		} catch (IOException e) {
