...
@Controller
public class JunerController {
    
    @RequestMapping("initWx")
    public void initWx(ServletRequest req, ServletResponse res) throws IOException{
        ...
        if (isGet) {  
            ...
            params.add(EnumWx.token.getValues());  
